...
then
	...
	mkdir /root/Desktop/iscriptResult/PRINTS
	...
	# 3 OUTPUTS + LOG                               #
	#################################################
	nmap -sV -sC --open -sSU -vv $2 --stylesheet nmap.xsl -oA /root/Desktop/iscriptResult/NMAP/nmap_result | tee /root/Desktop/iscriptResult/LOG/nmap_result.log
	...
	for ip in `cat /root/Desktop/iscriptResult/NMAP/port80`
		do 
			nikto -host $ip -port 80 -ask no -Format HTML -o /root/Desktop/iscriptResult/NIKTO/result_nikto.html | tee /root/Desktop/iscriptResult/LOG/nikto80.log
		done

	for ip in `cat /root/Desktop/iscriptResult/NMAP/port443`
		do 
			nikto -host $ip -port 443 -ask no -Format HTML -o /root/Desktop/iscriptResult/NIKTO/result_nikto.html | tee /root/Desktop/iscriptResult/LOG/nikto443.log
		done
	
	# Gerar o arquivo final para realizar a integração com o script de print.
	sed 's/^/https:\/\//g' /root/Desktop/iscriptResult/NMAP/port443 | sed 's/$/:443/g' > /root/Desktop/iscriptResult/final_result
	sed 's/^/http:\/\//g' /root/Desktop/iscriptResult/NMAP/port80 | sed 's/$/:80/g' >> /root/Desktop/iscriptResult/final_result
	...
	# Integração
	/iscript/./printscreen.sh -l /root/Desktop/iscriptResult/final_result
	...
	then
		...
		# UP.                                           #    
		#################################################
		nmap -Pn -sn -vv -T4 -iL $2 -oG /root/Desktop/iscriptResult/NMAP/pingscan | tee /root/Desktop/iscriptResult/LOG/pingscan.log
		...
		# 3 OUTPUTS + LOG                               #
		#################################################
		nmap -Pn -sS -sV --script discovery -iL /root/Desktop/iscriptResult/NMAP/uplist --stylesheet nmap.xsl -oA /root/Desktop/iscriptResult/NMAP/nmap_result | tee /root/Desktop/iscriptResult/LOG/nmap_result.log
		...
		sed 's/^/https:\/\//g' /root/Desktop/iscriptResult/NMAP/port443 | sed 's/$/:443/g' > /root/Desktop/iscriptResult/final_result
		sed 's/^/http:\/\//g' /root/Desktop/iscriptResult/NMAP/port80 | sed 's/$/:80/g' >> /root/Desktop/iscriptResult/final_result
		echo "Arquivo final_result criado."
		echo "Iniciando integração com PRINTSCREEN"

		# Integração
		/root/Desktop/Iscript/./printscreen.sh -l /root/Desktop/iscriptResult/final_result
		...
		mv /root/Desktop/iscriptResult/NMAP/port443 /root/Desktop/iscriptResult/LOG
		echo "##############################################################"		
		echo "# ALL DONE! RESULT CAN BE SEE IN /root/Desktop/iscriptResult #"
		echo "##############################################################"		
